<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(!empty(trim($user)) && !empty(trim($pass)) && !empty(trim($nama)) && !empty(trim($email)) && !empty(trim($email)) && !empty(trim($telpon)) && !empty(trim($level)) && !empty(trim($fakultas)) && !empty(trim($prodi))){

      if(tambah_data_admin($user,$pass,$nama,$email,$telpon,$level,$fakultas,$prodi)){

        echo '<div id="tampil_modal">
                <div id="modal">
                  <h5>BERHASIL !!</h5>
                  <h6>Anda Berhasil Menambahkan Data Admin"</h6>
                  <a href="seminar_daftar_admin.php" class="btn btn-success center-block">OKE</a>
                </div>
              </div>';

      }else{
        $error = 'Ada Masalah Saat Menambah Data Admin';
      }
...
<div class="menu">
  ...
  <div class="fluid-center" id="fluid-center" style="margin-top:-50px;">
    ...
    <div class="container">
      <h3 style="margin-top:-10px;">Form Tambah Admin</h3>
      <form id="form_admin" action="" method="post">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" name="user" placeholder="ex: 2012xxxxxx" value="">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" name="pass" placeholder="ex: 0501xx" value="">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" name="nama" placeholder="ex: fulan bin fulan" value="">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" name="email" placeholder="user@usermail.com" value="">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-lg" name="telpon" placeholder="ex: 0812xxxxxxx" value="">
            </div>
          </div>
        ...
        <button type="submit" class="btn btn-default btn-primary" name="submit">Tambah</button>
      </form>
    </div><!-- Akhir Container-->
